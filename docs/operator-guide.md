...
2. Register the client's intake: business type, target public function,
   prior filing history in the United Kingdom if any.
3. Run the advisor in read-only mode against the Find a Tender service (FTS) and Contracts Finder, governed by the Procurement Act 2023 (post-Brexit successor to the Public Contracts Regulations 2015).
...
- named referral relationship with UK-licensed counsel or a
...
a working referral relationship with UK-licensed counsel or a
registered agent for whatever licensed representation the law of
the United Kingdom requires for actual public-procurement filings.
