# cloud-itonami-iso3166-gbr

Open ISO 3166 Blueprint for **GBR**: the United Kingdom.
...
tax registration, and local-content rules in the United Kingdom, so the operator
...
- **Not the government of the United Kingdom.** See
...
- **Not legal or tax advice.** Every regulatory claim must cite the
  official source and route final filings to UK-licensed counsel
...
(ISO 3166 `GBR`). Required capabilities:
