...
`cloud-itonami-iso3166-gbr` is an OSS open-business blueprint. Governance covers both code and
the operator model.
...
UK-licensed counsel or a registered agent for whatever licensed
representation the law of the United Kingdom requires for public-procurement
filings.
